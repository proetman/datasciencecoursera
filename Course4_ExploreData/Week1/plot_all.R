...
# plot2.png
with(home_data, plot(datetime, global_active_power, type="l"))
...
# print(summary(home_data))
# print(table(home_data$date))
# print(sapply(home_data, class))
